task :new_post, [:post_name, :image_dir] do |t, args|
  ...
  images = files.map {|file| "<img src='http://photounrelated.com/images/#{args.image_dir}/#{file}' />"}
...
eom
  ...
  sh "scp -r /Users/#{ENV['USER']}/Desktop/#{args.image_dir} sophia@notuntitled.com:~/images"
